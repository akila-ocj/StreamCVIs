...
# usage: ./run_visualize_processed_data.sh processed_data/ plots_processed_data
if [ "$#" -ne 2 ]; then
...
export PYTHON_SCRIPT="visualize_processed_data.py"

# Find all CSV files in the input folder and visualize them in parallel
