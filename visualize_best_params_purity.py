...
def main(birch_dir, dbstream_dir, stream_kmeans_dir):
    ...
    ax.set_xticklabels(truncated_datasets, rotation=45, ha='right')

    # Set labels and title
    ax.set_xlabel('Datasets', fontsize=14)
    ax.set_ylabel('Purity Score', fontsize=14)
    ax.set_title('Purity Scores for Different Clustering Algorithms', fontsize=16)
    ax.legend(title='Clustering Algorithm')
